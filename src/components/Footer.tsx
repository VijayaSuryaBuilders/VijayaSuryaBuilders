    ...
    <footer className="bg-primary text-white">
      <div className="container mx-auto px-4 md:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          <div className="md:col-span-4">
            <div className="flex items-center mb-4">
              ...
              <span className="font-bebas text-2xl tracking-wider">VIJAYASURYA</span>
            </div>
            <p className="mb-6">
          ...
          <div className="md:col-span-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#strengths" className="hover:underline">Our Strengths</a>
              </li>
              <li>
          ...
          <div className="md:col-span-4">
            <h3 className="font-bebas text-xl tracking-wider mb-4">Contact Info</h3>
            <address className="not-italic space-y-2">
              ...
              <p>
                <span className="font-medium">Email:</span> vijayasuryabuilders13@gmail.com
              </p>
            </address>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-12 pt-6 text-center">
          <p>&copy; {currentYear} Vijayasurya Builders & Developers Pvt Ltd. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
